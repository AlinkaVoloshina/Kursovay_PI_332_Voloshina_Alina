...
<title>Удаление квалификаций</title>
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Qualifications Delete</title>
</head>
<body>
...
<div class="container">
	...
	<h3>Удаление наименований квалификаций</h3>
	<div class="container" id="container-form">
        <form method="POST" action="">
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" readonly
                           value="${qualificationDelete[0].getId()}" />
                </div>
            </div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					<input type="text" name="namequalification" class="form-control" id="namequalification" />
				</div>
			</div>
