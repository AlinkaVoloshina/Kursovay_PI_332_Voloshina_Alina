...
<div class="row mb-3">
	...
	<div class="row mb-3">
				...
				<div class="col-sm-10">
					...
					value="${groupEdit[0].getCountStudent()}" />
				</div>
			</div>
				...
				<div class="col-sm-10">
					...
					value="${groupEdit[0].getCountSubgrroup()}" />
				</div>
			</div>
