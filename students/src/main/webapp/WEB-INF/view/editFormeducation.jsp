...
<title>Редактирование форм обучения</title>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>FormEducation Edit</title>
</head>
<body>
...
<div class="container-fluid">
    ...
    <h3>Редактирование форм обучения</h3>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" readonly
                           value="${formeducationEdit[0].getId()}" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="nameform" id="nameform""
                           value="${formeducationEdit[0].getNameform()}" />
                </div>
            </div>
