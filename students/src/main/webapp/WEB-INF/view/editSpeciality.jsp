...
<title>Редактирование направление подготовки</title>
<head>
 <meta charset="UTF-8">
...
<div class="container">
	...
	<h3>Редактирование  направление</h3>
		...
		<div class="row mb-3">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					...
					value="${specialityEdit[0].getNamespeciality()}" />
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					...
					value="${specialityEdit[0].getProfile()}" />
				</div>
			</div>
